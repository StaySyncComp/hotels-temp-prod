...
export const reportsApi = {
  ...
  getDashboardStats: async (
    ...
    const response = await api.get(
      `/reports/dashboard-stats?organizationId=${organizationId}`,
    );
  ...
  getUrgentIssues: async (organizationId: number): Promise<UrgentIssue[]> => {
    const response = await api.get(
      `/reports/urgent-issues?organizationId=${organizationId}`,
    );
    return response.data;
  },
  ...
  getDepartmentPerformance: async (
    ...
    const response = await api.get(
      `/reports/department-performance?organizationId=${organizationId}`,
    );
    return response.data;
  },
  ...
  getPeakHours: async (organizationId: number): Promise<PeakHour[]> => {
    const response = await api.get(
      `/reports/peak-hours?organizationId=${organizationId}`,
    );
    return response.data;
  },
  ...
  getAverageCloseTime: async (organizationId: number): Promise<number> => {
    const response = await api.get(
      `/reports/averageCloseTime?organizationId=${organizationId}`,
    );
    return response.data;
  },
  ...
  getTopClosers: async (organizationId: number) => {
    const response = await api.get(
      `/reports/topClosers?organizationId=${organizationId}`,
    );
    return response.data;
  },
  ...
  getCallsByCategory: async (organizationId: number) => {
    const response = await api.get(
      `/reports/callsByCategory?organizationId=${organizationId}`,
    );
    return response.data;
  },
  ...
  getStatusPie: async (organizationId: number) => {
    const response = await api.get(
      `/reports/statusPie?organizationId=${organizationId}`,
    );
    return response.data;
  },
};
