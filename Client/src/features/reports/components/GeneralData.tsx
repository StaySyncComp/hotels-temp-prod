...
import { fetchCallCategories } from "@/features/calls/api/categories";
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-center">
        ...
        <p className="text-sm text-muted-foreground">
          {t("no_calls_found") === "no_calls_found"
            ? "לא נמצאו פניות"
            : t("no_calls_found")}
        </p>
      </div>
    ...
    <div className="space-y-6">
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-gray-800">
              {t("sla_compliance") === "sla_compliance"
                ? "עמידה ב-SLA"
                : t("sla_compliance")}
            </CardTitle>
          </CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-gray-800">
              {t("response_times") === "response_times"
                ? "זמני תגובה"
                : t("response_times")}
            </CardTitle>
          </CardHeader>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-gray-800">
              {t("efficiency_metrics") === "efficiency_metrics"
                ? "מדדי יעילות"
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-medium text-gray-700">
                  {t("avg_resolution_time") === "avg_resolution_time"
                    ? "זמן פתרון ממוצע"
