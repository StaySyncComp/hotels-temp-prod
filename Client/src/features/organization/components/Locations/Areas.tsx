...
import { updateAreas } from "@/features/organization/api/areas";
import { useQueryClient } from "@tanstack/react-query";
import { deleteAreas } from "@/features/organization/api/areas";
...
function Areas({ selectedArea, setSelectedArea }: AreasProps) {
  ...
  }, [areas, searchParams, setSearchParams, setSelectedArea]);
